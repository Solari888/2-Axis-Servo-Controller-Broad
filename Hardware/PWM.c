...
void PWM_Init(void)
{
	...
	TIM_OCStructInit(&TIM_OCInitStructure);//赋初始值，之后再更改想改的值
	...
	TIM_OCInitStructure.TIM_Pulse = 1500;//设置CCR
...
void PWM_SetCompare1(uint16_t Compare)//单独更改通道2的CCR值
{
	TIM_SetCompare1(TIM2,Compare);
}

void PWM_SetCompare2(uint16_t Compare)//单独更改通道2的CCR值
{
